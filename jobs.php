  ...
  <body>
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        ...
        <ul class="nav">
          <li class="main_tab active"><a data-type="jobs" href="#">Jobs</a></li>
          <li class="main_tab"><a data-type="builders" href="builders.php">Builders</a></li>
